...
IL_004c:
		{
			...
			L_14 = DataSnapshot_Child_mB06DEF2F4B31DA864DE9D422B28CDAE7F666034E(L_13, _stringLiteral5CAB87F6B3ED1D0AB3511FC787A210897543525E, /*hidden argument*/NULL);
			NullCheck(L_14);
			RuntimeObject * L_15;
			...
			L_19 = DataSnapshot_Child_mB06DEF2F4B31DA864DE9D422B28CDAE7F666034E(L_18, _stringLiteralFF844825CC929D4610B8E0B6E8FF3B702F8BB38F, /*hidden argument*/NULL);
			NullCheck(L_19);
			RuntimeObject * L_20;
			...
			L_24 = DataSnapshot_Child_mB06DEF2F4B31DA864DE9D422B28CDAE7F666034E(L_23, _stringLiteralECCC734F364206CB24A1C3B12ED53FDF863B173E, /*hidden argument*/NULL);
			NullCheck(L_24);
			RuntimeObject * L_25;
			...
			L_34 = DataSnapshot_Child_mB06DEF2F4B31DA864DE9D422B28CDAE7F666034E(L_33, _stringLiteral65F359F41E28BBB42EDAD258F896D7D6126E3066, /*hidden argument*/NULL);
			NullCheck(L_34);
			RuntimeObject * L_35;
			...
			L_39 = DataSnapshot_Child_mB06DEF2F4B31DA864DE9D422B28CDAE7F666034E(L_38, _stringLiteral65A16F28AF01E63DCD06496A0EC0043070A25037, /*hidden argument*/NULL);
			NullCheck(L_39);
			RuntimeObject * L_40;
			...
			NullCheck(L_43);
			DataSnapshot_tF0F9F103ABAA191BFDB3455240F45022EC9A4256 * L_44;
			L_44 = DataSnapshot_Child_mB06DEF2F4B31DA864DE9D422B28CDAE7F666034E(L_43, _stringLiteralE3A56BE62F0FB42D8062A17A4957C2142D815735, /*hidden argument*/NULL);
			NullCheck(L_44);
			RuntimeObject * L_45;
			L_45 = DataSnapshot_get_Value_m7F7C1E83D513F3E537030B4ACA0BFC4BF1E9BC2D(L_44, /*hidden argument*/NULL);
			NullCheck(L_45);
			String_t* L_46;
			L_46 = VirtFuncInvoker0< String_t* >::Invoke(3 /* System.String System.Object::ToString() */, L_45);
			__this->set_username_19(L_46);
			// maxLife = (float)vida;
			int32_t L_47 = __this->get_vida_18();
			__this->set_maxLife_11(((float)((float)L_47)));
			// currentLife = maxLife;
			float L_48 = __this->get_maxLife_11();
			__this->set_currentLife_12(L_48);
		}
...
IL_014b:
		{
			IL2CPP_LEAVE(0x157, FINALLY_014d);
		}
	} // end try (depth: 1)
...
IL_0157:
	{
		// usernameText.text = username;
		Text_t6A2339DA6C05AE2646FC1A6C8FCC127391BE7FA1 * L_53 = __this->get_usernameText_20();
		String_t* L_54 = __this->get_username_19();
		NullCheck(L_53);
...
IL_0169:
	{
		// print("Fallo la conexion");
		MonoBehaviour_print_m4F113B89EC1C221CAC6EC64365E6DAD0AF86F090(_stringLiteralB37A2DC1EDDE779FC22A462FEB7FAD9A22A6FB7F, /*hidden argument*/NULL);
		// });
		return;
	}
}
